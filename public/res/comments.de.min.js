...
function request(a,b,c,d){"use strict";var e=new XMLHttpRequest;return arguments.length==3?(d=c,c=null):c||(c=null),e.onreadystatechange=function(){e.readyState==4&&d(e.status,e.responseText)},e.open(a,b,!0),c&&e.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),e.send(c),e}typeof XMLHttpRequest=="undefined"&&(XMLHttpRequest=function(){try{return new ActiveXObject("Msxml2.XMLHTTP.6.0")}catch(a){}try{return new ActiveXObject("Msxml2.XMLHTTP.3.0")}catch(a){}try{return new ActiveXObject("Microsoft.XMLHTTP")}catch(a){}throw new Error("This browser does not support XMLHttpRequest.")}),function(b){function g(a){a.append(b.commentsNotAvailable),$("#cf, #cp").hide()}function h(a,b){"use strict";var d;return a.modified?d=c(a.modified):d=new Date,'<article class="comment'+(a.pingback?" ping":"")+(b?" new":"")+'">'+'<a id="'+a._id+'" class="bm"></a><header>'+(a.email.hash?'<figure class="avatar"><img src="http://www.gravatar.com/avatar/'+a.email.hash+'.jpg?s=60&d=mm" alt="Avatar"'+'width="60" height="60"></figure>':"")+'<p class="meta">'+(a.website?'<a href="'+a.website+'">':"")+a.author+(a.website?"</a>":"")+", "+(a._id?'<a href="#'+a._id+'" title="permalink">':"")+s(d)+(a._id?"</a>":"")+'</header><section class="matter">'+a.message+"</section></article></li>"}function i(a,b){"use strict";var c;for(c=0;c<b.length;c++)a.append(h(b[c]))}function j(a){var b=a.elements,c={};for(var d=0;d<b.length;d++)c[b[d].name]=b[d].value;return c}function k(a){var b=encodeURIComponent,c="",d=0;for(var e in a)c+=(d++>0?"&":"")+b(e)+"="+b(a[e]);return c}function l(a,b){var c=$("#cf-status");a=="ok"?c.attr("src","/res/tick.png"):a=="not ok"?c.attr("src","/res/error.png"):a=="load"?c.attr("src","/res/load.gif"):a=="error"&&c.attr("src","/res/exclamation.png"),c.show(),b&&window.setTimeout(function(){c.hide()},b*1e3)}function m(a){a.addClass("valid"),a.removeClass("invalid")}function n(a){a.addClass("invalid"),a.removeClass("valid")}function o(){var a=$("#cf-message"),b=$("#cf-author"),c=$("#cf-email"),d=$("#cf-website"),e=$("#cf-nospam");/./.test(a.val())?m(a):n(a),/./.test(b.val())?m(b):n(b),c.val()==""||/^.+@.+$/.test(c.val())?m(c):n(c),d.val()==""||/^((.+:)?\/\/)?.+\...+$/.test(d.val())?m(d):n(d),document.getElementById("cf-nospam").checked==1?m(e):n(e)}function p(){$("#cf-message").val(""),$("#cf-author").val(""),$("#cf-email").val(""),$("#cf-website").val(""),$("#cf-nospam").val(""),$("#cp-stage").children().remove()}function q(a){$("#clist").append(h(a,!0))}"use strict";var c=require("isodate"),d=require("marked"),e=require("MD5"),f=require("numpad");d.setOptions({pedantic:!1,gfm:!0,sanitize:!0}),$.domReady(function(){"use strict";var c,f=window.location.pathname,h=$("#comments");h&&(h.append("<h2>"+b.comments+'</h2><div id="clist"></div>'),c=$("#clist"),f=f.replace(/\/\//,"/"),request("GET","/res/comment-form."+b.lang+".tpl",function(h,m){"use strict";if(h===200){$("#comments").append(m);var n=$("#cf-message"),r=$("#cf-author"),s=$("#cf-email"),t=$("#cf-website"),u=$("#cf-nospam"),v=$("#cp-doc"),w=$("#cp-stage");request("GET","/log/comments?res="+f,function(b,d){"use strict";if(b===200){var e=JSON.parse(d);i(c,e)}else b>=400&&g(c)}),v.on("click",function(){window.open("/info/markdown."+b.lang+".html","Markdown","width=450,height=600")}),v.attr("href","javascript:void()"),n.on("keyup",function(a){w.html(d(n.val()))}),n.on("click",o),n.on("keyup",o),r.on("click",o),r.on("keyup",o),s.on("click",o),s.on("keyup",o),t.on("click",o),t.on("keyup",o),u.on("click",o),u.on("keyup",o),$("#cf-save").on("click",function(a){var b=j(document.forms.cf);l("load"),request("POST","/log/comments?res="+f,k(b),function(c,f){if(c===200){l("ok",5),p();var g=b.email;b.email={address:g,hash:e(g)},b.message=d(b.message),q(b)}else c===412?l("not ok"):l("error")})})}}))});var r;b.lang=="de"?r=function(a){return f(a.getDate())+"."+f(a.getMonth()+1)+"."+a.getFullYear()}:r=function(a){return a.getFullYear()+"-"+f(a.getMonth()+1)+"-"+f(a.getDate())};var s=function(a){return console.log(typeof a),r(a)+" "+f(a.getHours())+":"+f(a.getMinutes())}}(l10n);