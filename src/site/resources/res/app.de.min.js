...
function request(a,b,c,d){"use strict";var e=new XMLHttpRequest;return arguments.length==3?(d=c,c=null):c||(c=null),e.onreadystatechange=function(){e.readyState==4&&d(e.status,e.responseText)},e.open(a,b,!0),c&&e.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),e.send(c),e}typeof XMLHttpRequest=="undefined"&&(XMLHttpRequest=function(){try{return new ActiveXObject("Msxml2.XMLHTTP.6.0")}catch(a){}try{return new ActiveXObject("Msxml2.XMLHTTP.3.0")}catch(a){}try{return new ActiveXObject("Microsoft.XMLHTTP")}catch(a){}throw new Error("This browser does not support XMLHttpRequest.")}),function(b){function g(a,b){"use strict";var d;return a.modified?d=c(a.modified):d=new Date,'<article class="comment'+(b?" new":"")+'">'+'<a id="'+a._id+'" class="bm"></a><header>'+(a.email.hash?'<figure class="avatar"><img src="http://www.gravatar.com/avatar/'+a.email.hash+'.jpg?s=60&d=mm" alt="Avatar"'+'width="60" height="60"></figure>':"")+'<p class="meta">'+(a.website?'<a href="'+a.website+'">':"")+a.author+(a.website?"</a>":"")+", "+(a._id?'<a href="#'+a._id+'" title="permalink">':"")+r(d)+(a._id?"</a>":"")+'</header><section class="matter">'+a.message+"</section></article></li>"}function h(a,b){"use strict";var c;for(c=0;c<b.length;c++)a.append(g(b[c]))}function i(a){var b=a.elements,c={};for(var d=0;d<b.length;d++)c[b[d].name]=b[d].value;return c}function j(a){var b=encodeURIComponent,c="",d=0;for(var e in a)c+=(d++>0?"&":"")+b(e)+"="+b(a[e]);return c}function k(a,b){var c=$("#cf-status");a=="ok"?c.attr("src","/res/tick.png"):a=="not ok"?c.attr("src","/res/error.png"):a=="load"?c.attr("src","/res/load.gif"):a=="error"&&c.attr("src","/res/exclamation.png"),c.show(),b&&window.setTimeout(function(){c.hide()},b*1e3)}function l(a){a.addClass("valid"),a.removeClass("invalid")}function m(a){a.addClass("invalid"),a.removeClass("valid")}function n(){var a=$("#cf-message"),b=$("#cf-author"),c=$("#cf-email"),d=$("#cf-website"),e=$("#cf-nospam");/./.test(a.val())?l(a):m(a),/./.test(b.val())?l(b):m(b),c.val()==""||/^.+@.+$/.test(c.val())?l(c):m(c),d.val()==""||/^((.+:)?\/\/)?.+\...+$/.test(d.val())?l(d):m(d),document.getElementById("cf-nospam").checked==1?l(e):m(e)}function o(){$("#cf-message").val(""),$("#cf-author").val(""),$("#cf-email").val(""),$("#cf-website").val(""),$("#cf-nospam").val("")}function p(a){$("#clist").append(g(a,!0))}"use strict";var c=require("isodate"),d=require("marked"),e=require("MD5"),f=require("numpad");d.setOptions({pedantic:!1,gfm:!0,sanitize:!0}),$.domReady(function(){"use strict";var c,f=window.location.pathname,g=$("#comments");g&&(g.append("<h2>"+b.comments+'</h2><div id="clist"></div>'),c=$("#clist"),f=f.replace(/\/\//,"/"),request("GET","/res/comment-form."+b.lang+".tpl",function(g,l){"use strict";if(g===200){$("#comments").append(l);var m=$("#cf-message"),q=$("#cf-author"),r=$("#cf-email"),s=$("#cf-website"),t=$("#cf-nospam"),u=$("#cp-doc"),v=$("#cp-stage");request("GET","/log/comments?res="+f,function(b,d){"use strict";if(b===200){var e;e=JSON.parse(d),h(c,e)}}),u.on("click",function(){window.open("/info/markdown."+b.lang+".html","Markdown","width=450,height=600")}),u.attr("href","javascript:void()"),m.on("keyup",function(a){v.html(d(m.val()))}),m.on("click",n),m.on("keyup",n),q.on("click",n),q.on("keyup",n),r.on("click",n),r.on("keyup",n),s.on("click",n),s.on("keyup",n),t.on("click",n),t.on("keyup",n),$("#cf-save").on("click",function(a){var b=i(document.forms.cf);k("load"),request("POST","/log/comments?res="+f,j(b),function(c,f){if(c===200){k("ok",5),o();var g=b.email;b.email={address:g,hash:e(g)},b.message=d(b.message),p(b)}else c===412?k("not ok"):k("error")})})}}))});var q;b.lang=="de"?q=function(a){return f(a.getDate())+"."+f(a.getMonth()+1)+"."+a.getFullYear()}:q=function(a){return a.getFullYear()+"-"+f(a.getMonth()+1)+"-"+f(a.getDate())};var r=function(a){return console.log(typeof a),q(a)+" "+f(a.getHours())+":"+f(a.getMinutes())}}(l10n);
